...
def glouton():
    ...
    while (len(tabcorde)!=nbSommets-3):
        ...
        #suppresion de la corde du dictionnaire
        ...
        #ajout des nouvelles cordes exterieurs
...
def glouton_etape(tab):
    # recherche de la plus petite corde dans le dictionnaire
...
def valideCordeGlouton(tab):
    # supprime les cordes de tab qui ne sont plus valide
    tabtmp=tab.copy()
    for i in tab.keys():
...
def find_key(tab,v):
    # donne le clé qui correspond à la valeur k
